...
use types::{create_upload_info, UploadInfo, AcceptedUpload, create_accepted_upload};
use std::io::prelude::*;
...
impl ClientInterface {
    ...
    pub fn complete_upload(&self, repo_name: &str, uuid: &str, digest: &str) -> Result<AcceptedUpload, Error> {
        ...
        Ok(create_accepted_upload(uuid.to_owned(), resp.digest.to_owned(), repo_name.to_owned()))
